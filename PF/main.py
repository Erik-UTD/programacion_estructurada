        ...
        if opcion == '1' or opcion=="COMPRAR":
            ...
            if len(lista_ventas)>0:
                ...
                if exportar == "s":
                    ...
                    print(f"\n\t⚠️ Debes elegir una opcion...Intentalo de neuvo")
            else:
            ...
            if len(lista_ventas)>0:
                print("\n\t 📃 Ventas realizadas")
                print(f"{'ID Venta':<10}{'Nombre':<15}{'Cantidad':<15}{'Fecha':<15}")
                print(f"{'-'*50}")
...
def menu_admin():
    while True:
        ...
        if opcion == '1':
            ...
            if ventas:
                print("\n📄 Ventas registradas:\n")
                print(f"{'ID venta':<10}{'Usuario ID':<15}{'Nombre':<10}{'Cantidad':<15}{'Fecha':<15}")
                print(f"{'-'*70}")
                for fila in ventas:
                    fecha = fila[5]
                    if hasattr(fecha, "strftime"):
                        ...
                        fecha_str = str(fecha)
                    print(f"{fila[0]:<10}{fila[1]:<15}{fila[3]:<15}{fila[4]:<15}{fecha_str:<10}")
                print(f"{'-'*70}")
                id_venta = int(input("\n\tIntroduce el ID de la venta a eliminar: "))
                ids_disponibles=[fila[0] for fila in ventas]
                if id_venta in ids_disponibles:
                    sql = "DELETE FROM ventas WHERE id = %s"
                    cursor.execute(sql, (id_venta,))
                    conexion.commit()
                    print("\n\t✅ Venta eliminada exitosamente.")
                else:
                    print("\n\t❗ No hay ventas con ese ID.")   
            else:
            ...
            if ventas_registradas:
                print("\n📄 Ventas registradas:\n")
                print(f"{'ID venta':<10}{'Producto ID':<15}{'Nombre':<10}{'Cantidad':<20}{'Fecha':<20}")
                print(f"{'-'*70}")
                for fila in ventas_registradas:
                    ...
                    if hasattr(fecha, "strftime"):
                        ...
                        fecha_str = str(fecha)
                    print(f"{fila[0]:<10}{fila[2]:<15}{fila[3]:<10}{fila[4]:<20}{fecha_str:<20}")
                print(f"{'-'*70}")
                ...
                if venta:
                    ...
                    if hasattr(fecha, "strftime"):
                        ...
                        fecha_str = str(fecha)
                    print(f"{venta[0]:<10}{venta[1]:<15}{venta[2]:<15}{venta[3]:<20}{fecha_str:<20}")
                    print(f"{'-'*70}")
                else:
                    print("\n\t❗ Venta no encontrada.")
            else:
